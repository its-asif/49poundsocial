...
const HowItWorks = () => {
    return (
        <div className="bg-[#024963] p-6 md:p-10 text-white">
            <div className="text-center my-8">
                <h1 className="text-4xl md:text-6xl font-bold mb-2">How Does It Work?</h1>
                <h2  className="text-2xl md:text-4xl ">Dive In Today—It's A Piece Of Cake.</h2>
            </div>
            <div className="my-8 mt-10 grid grid-cols-1 md:grid-cols-3 gap-10">
                <div>
                    <h1 className="text-5xl md:text-7xl text-center font-bold text-[#f7b141]">
                        <CountUp 
                            end={1} 
                            duration={5} 

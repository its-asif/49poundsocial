        ...
        <div>
            <div className="hero min-h-screen px-10">
                <div className="hero-content grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="px-16">
                        <h1 className="text-4xl font-bold">Quality Doesn't Have To Break The Bank.</h1>
                        <p className="pt-4 font-bold text-xl text-black">
                    ...
                    <div 
                        ...
                        <img src="rocket-laptop.webp" className="max-w-md rounded-lg" />
                    </div>
                </div>
            </div>
        </div>
